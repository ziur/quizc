...
class MaxLengthValidator(object):
    MESSAGE = "The length of the value must be greater than {min_length}"
...
class OnlyUppercaseText(object):
    MESSAGE = "The text is not capitalized"

    def validate(self, value, condition_value, errors):
        if value.isupper() == False:  #verificacion para ver si value esta en mayuscula
            errors.append(self.MESSAGE)
...
class ValidatorType(Enum):
    ...
    UPPERCASE_TEXT = (7, OnlyUppercaseText())
