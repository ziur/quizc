...
class UtilsTest(unittest.TestCase):
    ...
    def test_factory_returns_required_validator(self):
        ...
        self.assertTrue(isinstance(required_validator, RequiredValidator),
                        "The validator is an instance of the RequiredValidator")
    ...
    def test_valid_date_validator(self):
        ...
        self.assertEqual(len(error), 0, "The date 12/21/2020 is a valid format")
    ...
    def test_max_length_validator(self):
        ...
        max_validator.validate("qwerty", 3, error)
        self.assertFalse(len(error) == 0)
    ...
    def test_value_length_more_than_expected(self):
        error = []
        max_validator = ValidatorType.get_validator(ValidatorType.MAX_LENGTH.code)
        max_validator.validate("abc", 4, error)
        self.assertTrue(len(error) == 0)
